    ...
    <div class="ps-sidebar" data-mh="product-listing">
      <aside class="ps-widget--sidebar ps-widget--category">
        <div class="ps-widget__header">
          <h3>Cell Phones & Accessories</h3>
        </div>
        <div class="ps-widget__content">
          <ul class="ps-list--checked">
            <li class="current"><a href="product-listing.html">Cell Phones</a></li>
            <li><a href="product-listing.html">Power Bank</a></li>
            <li><a href="product-listing.html">Smartwatch</a></li>
            <li><a href="product-listing.html">Headset/Earphones/Headphones</a></li>
            <li><a href="product-listing.html">Memory Card</a></li>
            <li><a href="product-listing.html">Cables</a></li>
            <li><a href="product-listing.html">Screen Protectors</a></li>
          </ul>
        </div>
      </aside>
      ...
      <aside class="ps-widget--sidebar ps-widget--category">
        ...
        <div class="ps-widget__content">
          <ul class="ps-list--checked">
            <li><a href="product-listing.html">Anker</a></li>
            <li class="current"><a href="{{ route('products.index') }}">Apple</a></li>
            <li><a href="product-listing.html">Aukey</a></li>
            <li><a href="product-listing.html">Kingstone</a></li>
            <li><a href="product-listing.html">Samsung</a></li>
            <li><a href="product-listing.html">SanDisk</a></li>
            <li><a href="product-listing.html">Xiaomi</a></li>
          </ul>
        </div>
      </aside>
      <aside class="ps-widget--sidebar ps-widget--category">
        ...
        <div class="ps-widget__content">
          <ul class="ps-list--checked">
            <li class="current"><a href="product-listing.html">New</a></li>
            <li><a href="product-listing.html">Used</a></li>
          </ul>
        </div>
      </aside>
